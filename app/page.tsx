...
function HomeContent() {
  ...
  return (
    <>
      ...
      <footer className="relative overflow-hidden" style={{backgroundColor: '#1a2b4a'}}>
        {/* Decorative Accent */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://www.facebook.com/qohira.zahra" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all text-gray-300 hover:text-[#d4a574] hover:bg-[#d4a574]/20" style={{
                ...
                <a href="https://www.instagram.com/qohira.zahra" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-all text-gray-300 hover:text-[#d4a574] hover:bg-[#d4a574]/20" style={{
                  backgroundColor: 'rgba(212, 165, 116, 0.1)',
                  border: '1px solid rgba(212, 165, 116, 0.3)'
                }}>
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="space-y-3">
                <a href="https://wa.me/6285620061990" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-300 hover:text-[#d4a574] transition-colors group">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors" style={{backgroundColor: 'rgba(212, 165, 116, 0.1)'}}>
                    <svg className="w-5 h-5 text-gray-300 group-hover:text-[#d4a574] transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span>0856 200 6199</span>
                </a>
                <a href="mailto:Achmadmoeslem@gmail.com" className="flex items-center gap-3 text-gray-300 hover:text-[#d4a574] transition-colors group">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors" style={{backgroundColor: 'rgba(212, 165, 116, 0.1)'}}>
                    <svg className="w-5 h-5 text-gray-300 group-hover:text-[#d4a574] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <span>Achmadmoeslem@gmail.com</span>
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-lg transition-all hover:bg-[#d4a574]/10" style={{backgroundColor: 'rgba(212, 165, 116, 0.05)', border: '1px solid rgba(212, 165, 116, 0.2)'}}>
                  <p className="text-sm font-semibold text-[#f4c794] mb-1">Bank BCA</p>
                  <p className="text-lg font-bold text-white mb-1" style={{fontFamily: 'monospace'}}>2831373298</p>
                  <p className="text-sm text-gray-300">a.n. ACHMAD MUSLIM</p>
                </div>
                <div className="p-4 rounded-lg transition-all hover:bg-[#d4a574]/10" style={{backgroundColor: 'rgba(212, 165, 116, 0.05)', border: '1px solid rgba(212, 165, 116, 0.2)'}}>
                  <p className="text-sm font-semibold text-[#f4c794] mb-1">Bank Mandiri</p>
                  <p className="text-lg font-bold text-white mb-1" style={{fontFamily: 'monospace'}}>1270010509626</p>
                  <p className="text-sm text-gray-300">a.n. ACHMAD MUSLIM</p>
                </div>
                <div className="p-4 rounded-lg transition-all hover:bg-[#d4a574]/10" style={{backgroundColor: 'rgba(212, 165, 116, 0.05)', border: '1px solid rgba(212, 165, 116, 0.2)'}}>
                  <p className="text-sm font-semibold text-[#f4c794] mb-1">Bank BRI</p>
                  <p className="text-lg font-bold text-white mb-1" style={{fontFamily: 'monospace'}}>059801057922509</p>
                  <p className="text-sm text-gray-300">a.n. ACHMAD MUSLIM</p>
                </div>
              </div>
            </div>
          ...
          {/* Bottom Bar */}
          <div className="pt-8 border-t" style={{borderColor: 'rgba(212, 165, 116, 0.2)'}}>
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <p className="text-gray-300 text-sm">
                &copy; 2026 Qohira. All rights reserved.
              </p>
              <div className="flex gap-6 text-sm">
                <a href="#" className="text-gray-300 hover:text-[#d4a574] transition-colors">Privacy Policy</a>
                <a href="#" className="text-gray-300 hover:text-[#d4a574] transition-colors">Terms of Service</a>
              </div>
            </div>
          </div>
        </div>
